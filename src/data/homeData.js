...
export const specialists = [
  {
    id: 1,
    name: 'رضا احمدی',
    role: 'متخصص ارشد اتوماسیون صنعتی',
    skills: ['SIMATIC S7', 'TIA Portal', 'WinCC', 'Drive'],
    experience: '۱۲ سال تجربه',
    verified: true,
    rating: 4.9,
    jobs: 147,
    specialties: ['PLC', 'درایو', 'HMI'],
    initials: 'را',
  ...
  },
  {
    id: 2,
    name: 'سعید مرادی',
    role: 'تکنسین ارشد برق صنعتی',
    skills: ['تعمیرات برد', 'تابلو برق', 'اینورتر', 'سروو'],
    experience: '۱۰ سال تجربه',
    verified: true,
    rating: 4.8,
    jobs: 98,
    specialties: ['برق صنعتی', 'درایو', 'PLC'],
    initials: 'سم',
  ...
  },
  {
    id: 3,
    name: 'مهدی رضایی',
    role: 'کارشناس ارشد ماشین‌آلات CNC',
    skills: ['CNC', 'هیدرولیک', 'پنوماتیک', 'Fanuc'],
    experience: '۱۵ سال تجربه',
    verified: true,
    rating: 5.0,
    jobs: 203,
    specialties: ['CNC', 'هیدرولیک', 'مکانیک'],
    initials: 'مر',
    bg: 'linear-gradient(145deg, #4F46E5, #2563EB)',
  },
  {
    id: 4,
    name: 'حمید کریمی',
    role: 'متخصص ارشد هیدرولیک و پنوماتیک',
    skills: ['هیدرولیک', 'پمپ', 'سروو موتور', 'Rexroth'],
    experience: '۱۰ سال تجربه',
    verified: true,
    rating: 4.7,
    jobs: 82,
    specialties: ['هیدرولیک', 'پنوماتیک', 'تعمیرات'],
    initials: 'حک',
    bg: 'linear-gradient(145deg, #1D4ED8, #1E40AF)',
  },
]
